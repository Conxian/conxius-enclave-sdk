---
number: 137
title: "chore(deps): bump github/codeql-action/init from 3.36.2 to 4.36.2"
state: closed
...
updated: 2026-07-05
merged: 2026-07-05
url: https://github.com/Conxian/conxius-enclave-sdk/pull/137
source: github
branch: dependabot/github_actions/github/codeql-action/init-4.36.2 -> main
---

# chore(deps): bump github/codeql-action/init from 3.36.2 to 4.36.2

**PR #137** | CLOSED | Author: dependabot[bot] | Created: 2026-06-27 | Merged: 2026-07-05

Branch: `dependabot/github_actions/github/codeql-action/init-4.36.2` → `main`

Bumps [github/codeql-action/init](https://github.com/github/codeql-action) from 3.36.2 to 4.36.2.
<details>
