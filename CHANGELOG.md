...
### Added
- Repository hygiene enforcement in CI to prevent tracking of `Cargo.lock`, `notes.md`, and pre-commit artifacts.
- Explicit "Architectural Boundaries & Ownership" section in `GOVERNANCE.md` (consolidated from `REPO_OWNERSHIP.md`).

### Removed
- Redundant `REPO_OWNERSHIP.md` file.
- Tracked developer scratchpad (`notes.md`) and workflow artifacts (`pre_commit_review.json`).
